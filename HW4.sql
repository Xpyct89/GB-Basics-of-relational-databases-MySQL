...
*/
-- Generation time: Mon, 18 Jul 2022 14:15:19 +0000
-- Host: mysql.hostinger.ro
-- DB name: u574849695_26
...
*/
# Тема курсового проекта пока не определена. С большей долей вероятности, это будет база клиентов организации либо база товаров магазина